...
public class Diff
{
   ...
   public String printall()
   {
	   String output="";
	    for (Object obj : diffs)
	    {
          ...
          //  //System.out.printf("Add %s ---%s, Delete %s---%s\n",cur.getAddedStart(), cur.getAddedEnd(),
            	//	 cur.getDeletedStart(),cur.getDeletedEnd());
             
	    }
	    
	   return output;
   }
   //  �����ж��ٲ�ͬ������һ���ַ��ɾ��һ���ַ���һ����λ��?difference
   ...
   /*
    ...
    {
//        //args[0]="D:\\TEST\\file1.java";
//       // args[1]="D:\\TEST\\file2.java";
//    	String[] newargs=new String[]{"D:\\TEST\\file1.java","D:\\TEST\\file2.java"};
//        DiffJ dj = new DiffJ(newargs);
